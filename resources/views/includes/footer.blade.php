    ...
    <div class="row footer-grid container">
        ...
        <div class="row">
            <div class="col s10 m6 offset-m3 offset-s1">
                <span style="float: left;">SGGSIE&T © 2017</span> <span style="float: right;"><a href="http://onlinesggs.org/"> Home</a></span>
            </div>
        </div>
    </div>
</div>
...
{{--custom--}}
<script src="assets/js/script.js?no-cache=<?php echo time(); ?>"></script>
